...
namespace :gems do
  ...
  task :install do
    required_gems = %w{ sinatra dm-core dm-aggregates dm-validations dm-timestamps
                        dm-is-paginated merb-pagination haml rspec rspec_hpricot_matchers
                        haml pauldix-feedzirra thoughtbot-factory_girl }
